...
const ServiceDetails = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="service-details flex flex-col md:flex-row shadow-lg rounded-md overflow-hidden">
        <div className="service-info flex-1 p-6">
          ...
          <p className="mt-2  font-medium">Category: {category}</p>
          <p className="mt-2 text-xl font-semibold text-blue-600">Price: ${price}</p>
        </div> 
       <div className='flex items-center flex-col justify-center'>
       <div className="reviews-section flex-1 p-6  rounded-md">
          <h2 className="text-2xl font-semibold ">Reviews ({reviews.length})</h2>
          {reviews.length === 0 ? (
            <p className="mt-4 ">No reviews yet. Be the first to leave a review!</p>
          ) : (
        ...
        </div>
        {
          ...
          <button 
            ...
            className="py-2 px-4 bg-primary rounded-md disabled:bg-gray-300"
          >
            Previous
          </button>
      ...
      <div className="add-review-form mt-8  p-6 rounded-md shadow-md">
